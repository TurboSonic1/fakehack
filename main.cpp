...
int main(){ 
    ...
    LPCSTR convertedb = decrypta.c_str();
    LPCSTR convertedc = decrypta.c_str();
    LPCSTR convertedd = decrypta.c_str();
    LPCSTR convertede = decrypta.c_str();
    LPCSTR convertedf = decrypta.c_str();
    LPCSTR convertedg = decrypta.c_str();
    LPCSTR convertedh = decrypta.c_str();
